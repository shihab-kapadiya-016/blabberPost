...
import { CheckCircle2, Eye, EyeOff, Upload, UserPlus, X, XCircle } from "lucide-react";
...
const RegisterPage = () => {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            const imageKitFileUploadRes = await UploadFile(selectedFile, { token, expire, publicKey, signature })
                ...
                <Card className="border-0 shadow-2xl bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl rounded-2xl">
                    ...
                    <CardContent className="px-6 pb-8">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            {/* Submit Button */}
                            <Button type="submit" className="w-full h-10 gap-2 rounded" disabled={isSubmitting}>
                                {isSubmitting ? (
                                    <>
                        ...
                        <p className="text-center text-sm text-neutral-600 dark:text-neutral-400 mt-6">
                            ...
                            <Link href="/signin" className="font-semibold underline hover:text-purple-500">
                                Log in
                            </Link>
                        </p>
                    </CardContent>
